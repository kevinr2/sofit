...
<div class="row" >
  ...
  <div class="col-lg-12">
    ...
    <div class="panel panel-default" style="border-color: #fc704c;border-left-color: #fff;border-bottom-color: #fff;border-right-color: #fff;">
       <div class="panel-heading">Has iniciado sesión como <strong>Administrador</strong>
 ...
 <div class="col-lg-4 col-md-6">
   ...
   <div class="panel panel-danger">
      <div class="panel-heading" style="background-color: #fc704c">
         <div class="row">
            <div class="col-xs-3">
               <em class="fa fa-area-chart fa-4x"></em>
            </div>
            <div class="col-xs-9 text-right">
               <div class="text-lg">Asistencia</div>
               <p class="m0">Reporte de asistencia al gimnasio</p>
            </div>
         </div>
      </div>
      <a href="?vista=reporteAsistencia" class="panel-footer bg-dark bt0 clearfix btn-block" style="background-color: #373c38;">
         <span class="pull-left">Ver el gráfico</span>
  ...
  <div class="col-lg-4 col-md-6">
   ...
   <div class="panel panel-danger">
      <div class="panel-heading" style="background-color: #fc704c">
         <div class="row">
            <div class="col-xs-3">
               <em class="fa fa-bar-chart fa-4x"></em>
            </div>
            <div class="col-xs-9 text-right">
               <div class="text-lg">Asistencia a Eventos</div>
               <p class="m0">Reporte de asistencia a eventos</p>
            </div>
         </div>
      </div>
      <a href="?vista=reporteAEventos" class="panel-footer bg-dark bt0 clearfix btn-block" style="background-color: #373c38;">
         <span class="pull-left">Ver el gráfico</span>
         <span class="pull-right">
            <em class="fa fa-chevron-circle-right"></em>
         </span>
  ...
  <div class="col-lg-4 col-md-6">
    ...
    <div class="panel panel-danger">
       <div class="panel-heading" style="background-color: #fc704c">
          <div class="row">
             <div class="col-xs-3">
                <em class="fa fa-list fa-4x"></em>
             </div>
             <div class="col-xs-9 text-right">
                <div class="text-lg">Inventario</div>
                <p class="m0">Reportes de inventario</p>
             </div>
          </div>
       </div>
       <a href="?vista=reporteInventario" class="panel-footer bg-dark bt0 clearfix btn-block" style="background-color: #373c38;">
          <span class="pull-left">Ver inventarios</span>
          <span class="pull-right">
             <em class="fa fa-chevron-circle-right"></em>
          </span>
       </a>
   ...
   <div class="col-lg-4 col-md-6">
    ...
    <div class="panel panel-danger">
       <div class="panel-heading" style="background-color: #fc704c">
          <div class="row">
             <div class="col-xs-3">
                <em class="fa fa-envelope fa-4x" style="font-size: 4.3em;"></em>
             </div>
             <div class="col-xs-9 text-right">
                <div class="text-lg">Novedades</div>
                <p class="m0">Gestión de las novedades del Gym</p>
             </div>
          </div>
       </div>
       <a href="?vista=bandejaNovedades" class="panel-footer bg-dark bt0 clearfix btn-block" style="background-color: #373c38;">
          <span class="pull-left">Abrir bandeja de entrada</span>
          <span class="pull-right">
             <em class="fa fa-chevron-circle-right"></em>
          </span>
       </a>
  ...
  <div class="col-lg-4 col-md-6">
    ...
    <div class="panel panel-danger">
       <div class="panel-heading" style="background-color: #fc704c">
          <div class="row">
             <div class="col-xs-3">
                <em ><img src="app/img/icon_user.png" alt="" style="width: 60px;"></em>
             </div>
             <div class="col-xs-9 text-right">
                <div class="text-lg">Usuarios</div>
                <p class="m0">Cambiar permisos de usuario</p>
             </div>
          </div>
       </div>
       <a href="?vista=permisosUsuario" class="panel-footer bg-dark bt0 clearfix btn-block" style="background-color: #373c38;">
  ...
  <div class="col-lg-4 col-md-6">
    ...
    <div class="panel panel-danger">
       <div class="panel-heading" style="background-color: #fc704c">
          <div class="row">
             <div class="col-xs-3">
                <em class="fa fa-calendar fa-4x" style="font-size: 4.3em;"></em>
             </div>
             <div class="col-xs-9 text-right">
                <div class="text-lg">Gestión de Eventos</div>
                <p class="m0">Crear/Modificar eventos</p>
             </div>
          </div>
       </div>
       <a href="?vista=eventos" class="panel-footer bg-dark bt0 clearfix btn-block" style="background-color: #373c38;">
          <span class="pull-left">Abrir menú de eventos</span>
          <span class="pull-right">
             <em class="fa fa-chevron-circle-right"></em>
          </span>
       </a>
...
<div class="row">
  <div class="col-lg-12">
    <!-- START panel-->
    <div class="panel panel-default" style="border-color: #fc704c;border-left-color: #fff;border-bottom-color: #fff;border-right-color: #fff;">
       <div class="panel-heading">Opciones de Entrenador
          <a href="#" data-perform="panel-dismiss" data-toggle="tooltip" title="Cerrar" class="pull-right">
             <em class="fa fa-close"></em>
          </a>
       </div>
 ...
 <div class="col-lg-4 col-md-6">
    ...
    <div class="panel panel-danger anim-running anim-done" data-onload data-toggle="play-animation" data-play="fadeInLeft" data-offset="0" data-delay="100" style="">
       <div class="panel-heading" style="background-color: #fc704c">
          <div class="row">
             <div class="col-xs-3">
                <em class="fa fa-id-card-o fa-4x"></em>
             </div>
             <div class="col-xs-9 text-right">
                <div class="text-lg">Asistencia</div>
