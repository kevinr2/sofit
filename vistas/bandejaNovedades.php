                        ...
                        <tr class="mb-mail">
                            ...
                            <div class="pull-left">
                                <?php if ($fila['estado_Novedad'] == "Enviado") { ?>
                                    ...
                                    <a href="?vista=verNovedad&idn=<?php echo $fila['id_Novedad']?>"><div class="mb-mail-subject" style="color: #4e4e4e;"><?php echo utf8_encode($fila['asunto_Novedad'])?> </div></a>
                                <?php }else{?>
                                    <div class="mb-mail-from " style="color: #4e4e4e;font-weight: 400;"><?php echo $fila['nombres_Usuario']." ".$fila['apellidos_Usuario']?></div>
                                    <a href="?vista=verNovedad&idn=<?php echo $fila['id_Novedad']?>"><div class="mb-mail-subject " style="color: #4e4e4e;font-weight: 400;"><?php echo utf8_encode($fila['asunto_Novedad'])?></div></a>
                                <?php }?>
                            </div>
                            <div class="mb-mail-preview"><?php echo utf8_encode($fila['descripcion_Novedad'])?>.</div>
                            </td>
                        </tr>
                        <?php }?>
                    </tbody>
