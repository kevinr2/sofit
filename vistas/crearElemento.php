      ...
      <form method="POST" enctype="multipart/form-data" data-parsley-validate="" novalidate="">
        ...
        <div class="form-group col-lg-6">
          ...
          <div class="datetimepicker input-group date col-lg-12">
            <input type="text" class="form-control" name="fecha_Elemento" required>
        ...
        <div class="form-group col-lg-6">
          ...
          <input type="number" placeholder="Cantidad Elemento" class="form-control" name="cantidad_Elemento" required>
        </div>
    </div>
