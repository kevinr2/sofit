...
<head>
   ...
   <!-- END Page Custom CSS-->
   <!-- App CSS-->
  <link rel="stylesheet" href="app/css/app-entrenador.css">
   ...
   <div class="wrapper" >
      ...
      <nav role="navigation" class="navbar navbar-default navbar-top navbar-fixed-top">
         ...
         <div class="navbar-header">
            <a href="index-entrenador.php" class="navbar-brand">
         ...
         <div class="nav-wrapper" style="background-color: #fc74c;">
            ...
            <ul class="nav navbar-nav">
               ...
               <li>
                  <!-- Button used to collapse the left sidebar. Only visible on tablet and desktops-->
                  <a href="fpdf/manuales/Manualdelentrenador.pdf">
      ...
      <aside class="aside">
         ...
         <nav class="sidebar">
            ...
            <ul class="nav">
               ...
               <li id="inicio">
                  <a href="index-entrenador.php" title="Inicio" data-toggle="" class="no-submenu">
               ...
               <li id="eventos">
                  ...
                  <li id="verEvento">
                        <a href="?vista=verEventos" title="Crear Inventario" data-toggle="" class="no-submenu">
                          <span class="item-text">Listado Eventos</span>
                        </a>
                    </li>
                  </ul>
                  <!-- END SubMenu item-->
               ...
               <li class="nav-heading">Información de Usuarios</li>
               <li id="modRutinas">
                  ...
                  <a href="?vista=editarPerfil" class="media p mt0">
                     ...
                     <span class="media-body">
                        <span class="media-heading">
                           ...
                           <br>
                           <small class="text-muted"><?php echo utf8_encode($fila['nombre_Programa']); ?></small>
                        </span>
                     </span>
                  </a>
                  <!-- END User status-->
